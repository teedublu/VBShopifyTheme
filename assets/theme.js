...
import { animate, timeline as timeline2, stagger } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { stagger as stagger2 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as animate2, stagger as stagger3, inView } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { inView as inView2 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { timeline as timeline3, inView as inView3 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as animate3 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as animate4 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";

// js/common/overlay/dialog-element.js
import { FocusTrap, Delegate } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as motionAnimate, timeline as motionTimeline } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as motionAnimate2, timeline as motionTimeline2 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { Delegate as Delegate2 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as animate5 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as animate6, timeline as timeline4, stagger as stagger4 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { Delegate as Delegate3 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { PhotoSwipeLightbox } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
var ProductGallery = class extends HTMLElement {
  ...
  get photoswipe() {
    ...
    const photoswipe = new PhotoSwipeLightbox({
      pswpModule: () => import("//voxblock.co.uk/cdn/shop/t/108/assets/photoswipe.min.js?v=20290624223189769891708597196"),
      bgOpacity: 1,
...
import { animate as animate7, timeline as timeline5 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { inView as inView4 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
    ...
    if (this.hasAttribute("show-play-button") && !this.shadowRoot) {
      this.attachShadow({ mode: "open" }).appendChild(document.createRange().createContextualFragment(`
        ...
        <svg part="play-button" fill="none" width="48" height="48" viewBox="0 0 48 48">
          ...
          <path d="M18.578 32.629a.375.375 0 0 1-.578-.316V15.687c0-.297.328-.476.578-.316l12.931 8.314c.23.147.23.483 0 .63L18.578 32.63Z" fill="#565656"/>
          <path d="M24 .5C36.979.5 47.5 11.021 47.5 24S36.979 47.5 24 47.5.5 36.979.5 24 11.021.5 24 .5Z" stroke="#565656" stroke-opacity=".12"/>
        </svg>
      `));
    }
  }
...
import { timeline as timeline6 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as animate8 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as animate9 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
import { animate as animate10, inView as inView5 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
...
// js/theme.js
import { Delegate as Delegate4 } from "//voxblock.co.uk/cdn/shop/t/108/assets/vendor.min.js?v=52426788336887041471709828153";
(() => {
